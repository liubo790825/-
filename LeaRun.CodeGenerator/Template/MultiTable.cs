    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                if (isChildTable)
                {
                    sb.Append("            this." + multiTableConfigModel.ChildTablePk + " = Guid.NewGuid().ToString();//根据实际需要去修改\r\n");
                }
                else
                {
                    sb.Append("            this." + multiTableConfigModel.DataBaseTablePK + " = Guid.NewGuid().ToString();//根据实际需要去修改\r\n");
                }
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("        public IEnumerable<" + multiTableConfigModel.EntityClassName + "> GetPageList(string conn, Pagination pagination, string queryJson)\r\n");
            sb.Append("        {\r\n");
            ...
            sb.Append("             expression = expression.And(t => t." + multiTableConfigModel.DataBaseTablePK + " > 0);\r\n");
            //sb.Append("             return this.BaseRepository(conn).FindList<" + multiTableConfigModel.EntityClassName + ">(expression,pagination);\r\n");
            ...
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        public " + multiTableConfigModel.EntityClassName + " GetEntity(string conn, string keyValue)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return this.BaseRepository(conn).FindEntity<" + multiTableConfigModel.EntityClassName + ">(keyValue);\r\n");
            sb.Append("        }\r\n");
            ...
            sb.Append("        /// <param name=\"keyValue\">主键值</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        public IEnumerable<" + multiTableConfigModel.ChildTableName + "Entity> GetDetails(string conn, string keyValue)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return this.BaseRepository(conn).FindList<" + multiTableConfigModel.ChildTableName + "Entity>(\"select * from " + multiTableConfigModel.ChildTableName + " where " + multiTableConfigModel.ChildTableForeignkey + "='\" + keyValue + \"'\");\r\n");
            ...
            sb.Append("        {\r\n");
            sb.Append("            IRepository db = new RepositoryFactory().BaseRepository(conn).BeginTrans();\r\n");
            sb.Append("            try\r\n");
            sb.Append("            {\r\n");
            ...
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        public void SaveForm(string conn, string keyValue, " + multiTableConfigModel.EntityClassName + " entity,List<" + multiTableConfigModel.ChildTableName + "Entity> entryList)\r\n");
            sb.Append("        {\r\n");

            sb.Append("          IRepository db = this.BaseRepository(conn).BeginTrans();\r\n");
            sb.Append("          try\r\n");
            sb.Append("          {\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("        /// <param name=\"queryJson\">查询参数</param>\r\n");
            sb.Append("        /// <returns>返回分页列表</returns>\r\n");
            sb.Append("        IEnumerable<" + multiTableConfigModel.EntityClassName + "> GetPageList(string conn, Pagination pagination, string queryJson);\r\n");
            ...
            sb.Append("        /// <param name=\"keyValue\">主键值</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        " + multiTableConfigModel.EntityClassName + " GetEntity(string conn, string keyValue);\r\n");
            ...
            sb.Append("        /// <param name=\"keyValue\">主键值</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        IEnumerable<" + multiTableConfigModel.ChildTableName + "Entity> GetDetails(string conn, string keyValue);\r\n");
            ...
            sb.Append("        /// <param name=\"entity\">实体对象</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        void SaveForm(string conn, string keyValue, " + multiTableConfigModel.EntityClassName + " entity,List<" + multiTableConfigModel.ChildTableName + "Entity> entryList);\r\n");
            sb.Append("        #endregion\r\n");
            sb.Append("    }\r\n");
            sb.Append("}\r\n");
            return sb.ToString();
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("        public " + multiTableConfigModel.BusinesClassName + "()\r\n");
            sb.Append("        {\r\n");
            sb.Append("            SystemManage.DataBaseLinkBLL databaseLinkBLL = new Busines.SystemManage.DataBaseLinkBLL();\r\n");
            sb.Append("            conEntity = databaseLinkBLL.GetEntity(\"" + multiTableConfigModel.DataBaseLinkId + "\");\r\n");//生成时实时去取
            sb.Append("        }\r\n");
            sb.Append("        #endregion\r\n");
            ...
            sb.Append("        {\r\n");
            sb.Append("            return service.GetDetails(conEntity.DbConnection,keyValue);\r\n");
            sb.Append("        }\r\n");
            ...
            sb.Append("            try\r\n");
            sb.Append("            {\r\n");
            sb.Append("                service.SaveForm(conEntity.DbConnection,keyValue, entity, entryList);\r\n");
            sb.Append("            }\r\n");
            sb.Append("            catch (Exception)\r\n");
            sb.Append("            {\r\n");
            sb.Append("                throw;\r\n");
