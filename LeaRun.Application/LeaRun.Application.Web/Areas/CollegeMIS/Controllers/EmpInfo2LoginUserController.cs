...
namespace LeaRun.Application.Web.Areas.CollegeMIS.Controllers
{
    ...
    /// 描 述：高职员工账号生成
    /// </summary>
    public class EmpInfo2LoginUserController : MvcControllerBase
    {
        private EmpInfo2LoginUserBLL empinfo2loginuserbll = new EmpInfo2LoginUserBLL();
        ...
        {
            var data = empinfo2loginuserbll.GetList(queryJson);
        ...
        {
            var data = empinfo2loginuserbll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        #endregion
        ...
        {
            var data = empinfo2loginuserbll.GetList("");
            LeaRun.Application.Busines.BaseManage.UserBLL ubll = new Busines.BaseManage.UserBLL();
            LeaRun.Application.Busines.BaseManage.RoleBLL rbll = new Busines.BaseManage.RoleBLL();
            ...
            foreach (var item in data)
            {
                ...
                if (flag == null)
                {
                    ...
                    var testuser = ((List<LeaRun.Application.Entity.CollegeMIS.EmpInfo2LoginUserEntity>)data).FindAll(s => s.EmpName == item.EmpName);
                    ...
                    if (testuser.Count > 1)
                    {
                        ...
                        //else
                        {
                            ...
                            var d = dlist.Find(s => s.FullName == item.DeptName);
                            ue.DepartmentId = d == null ? "" : d.DepartmentId;
                            var r = rplist.Find(s => s.FullName == item.Zhiwugongzhong);
        ...
        {
            empinfo2loginuserbll.RemoveForm(keyValue);
            return Success("删除成功。");
        }
        /// <summary>
        /// 保存表单（新增、修改）
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, EmpInfo2LoginUserEntity entity)
        {
            empinfo2loginuserbll.SaveForm(keyValue, entity);
            return Success("操作成功。");
        }
        #endregion
    }
