...
namespace LeaRun.Application.Web.Areas.HVSMIS.Controllers
{
    ...
    {
        private StuInfoGraduateBLL stuinfograduatebll = new StuInfoGraduateBLL();
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            var data = stuinfograduatebll.GetPageList(pagination, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = stuinfograduatebll.GetList(queryJson);
        ...
        {
            var data = stuinfograduatebll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        #endregion
        ...
        {
            stuinfograduatebll.RemoveForm(keyValue);
            return Success("删除成功。");
        }
        /// <summary>
        /// 保存表单（新增、修改）
        ...
        {
            stuinfograduatebll.SaveForm(keyValue, entity);
            return Success("操作成功。");
        }
        #endregion
    }
