(function (b) {
    ...
    d.jgrid.extend({
        ...
        setTreeGrid: function () {
            return this.each(function () {
                ...
                if (b.p.treeGrid) {
                    ...
                    function (a, e) {
                        e && -1 === d.inArray(e, g) && ("leafield" === a && (b.p._treeleafpos = c), c++, b.p.colNames.push(e), b.p.colModel.push({
                            name: e,
                            width: 1,
                            hidden: !0,
                            sortable: !1,
        ...
        isNodeLoaded: function (b) {
            ...
            this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var a = this.p.treeReader.leafield,
