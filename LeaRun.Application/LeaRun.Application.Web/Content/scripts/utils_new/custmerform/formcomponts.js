	...
	t.components = {
		text: {
			...
			renderTable: function (t) {
                ...
                i;
				var colspanlength = 1;
				if (t.type=="texteditor") {
				    colspanlength = 3;
				}
				return r += '<td class="formValue custmerTd" data-type="' + t.type + '"  data-value="' + t.field + '"  colspan="'+colspanlength+'"  ><input id="' + t.id + '" type="text" class="form-control" ' + o(t.verify) + " /><\/td>",
                i = n(r),
