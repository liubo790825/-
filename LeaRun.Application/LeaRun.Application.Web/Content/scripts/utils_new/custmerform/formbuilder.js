(function (n, t) {
        ...
        two: {
            ...
            2: {
                init: function (r) {
                    ...
                    }); !r || (u = JSON.parse(r.FrmContent), u.data.url != "" && u.data.url != undefined && u.data.url != null && (n("#url").val(u.data.url), i.two.isSystemFormLoaded = "init", i.two.isSystemFormOk = !1, n("#systemFormiframe").attr("src", u.data.url)))
                }
            }
        }
    },
    r = {
        ...
        draftButtton: function () {
            ...
            t.saveForm({
                url: "../../FormManage/FormModule/SaveForm?keyValue=" + r.keyValue,
                param: u,
                loading: "正在保存数据...",
                success: function () {
