(function (n) {
    ...
    t = {
        init: function () {
            ...
            $.SetForm({
                url: "../../SystemManage/ExcelImport/GetFormJsonByModuleId_old",
            ...
            var i = n(".nav-tabs"),
            f = "";
            f += '<li class="active"   data-value=""><a >' + r.templateInfo.F_Name + "<\/a><\/li>";
            ...
            n("#girdPager .prev").on("click",function () {
                    var i = parseInt(n(this).attr("data-value")) - 1;
                    i >= 0 && t.jgGirdRendering(u, 0, 30)
                });
            n("#girdPager .next").on("click",function () {
                var i = parseInt(n(this).attr("data-value")) + 1;
                i >= 0 && t.jgGirdRendering(u, 0, 30)
            })
        },
