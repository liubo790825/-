        ...
        one: {
            ...
            init: function () {
                ...
                t.jqGrid({
                    ...
                    autowidth: !0,
                    colModel: [
                        { label: "表名", name: "name", width: 260, align: "left", sortable: !1 },
                        { label: "主键", name: "pk", width: 150, align: "left", sortable: !1 },
                        {
                            label: "记录数", name: "sumrows", width: 100, align: "left", sortable: !1,
                            formatter: function (n) {
                                return n + "条"
                            }
                        },
                        { label: "使用大小", name: "reserved", width: 100, align: "left", sortable: !1 },
                        { label: "更新时间", name: "updatetime", width: 120, align: "left", sortable: !1 },
                        { label: "说明", name: "tdescription", width: 120, align: "left", sortable: !1 }
                    ],
                    rowNum: "1000",
                    rownumbers: !0,
                    shrinkToFit: !1,
                    ...
                    subGridRowExpanded: function (i, r) {
                        ...
                        n("#" + u).jqGrid({
                            ...
                            height: "100%",
                            colModel: [
                                { label: "列名", name: "column", index: "column", width: 250, sortable: !1 },
                            { label: "数据类型", name: "datatype", index: "datatype", width: 120, align: "center", sortable: !1 },
                            { label: "长度", name: "length", index: "length", width: 57, align: "center", sortable: !1 },
                            {
                                label: "允许空", name: "isnullable", index: "isnullable", width: 58, align: "center", sortable: !1,
                                formatter: function (n) {
                                    return n == 1 ? '<i class="fa fa-check-square-o"><\/i>' : '<i class="fa fa-square-o"><\/i>'
                                }
                            },
                            {
                                label: "标识", name: "identity", index: "identity", width: 58, align: "center", sortable: !1,
                                formatter: function (n) {
                                    return n == 1 ? '<i class="fa fa-check-square-o"><\/i>' : '<i class="fa fa-square-o"><\/i>'
                                }
                            },
                            {
                                label: "主键", name: "key", index: "key", width: 57, align: "center", sortable: !1,
                                formatter: function (n) {
                                    return n == 1 ? '<i class="fa fa-check-square-o"><\/i>' : '<i class="fa fa-square-o"><\/i>'
                                }
                            },
                            { label: "默认值", name: "defaults", index: "defaults", width: 120, align: "center", sortable: !1 },
                            { label: "说明", name: "remark", index: "remark", width: 100, sortable: !1 }
                            ],
                            caption: "表字段信息",
                            rowNum: "1000",
                            rownumbers: !0,
        ...
        two: {
                ...
                if (r) n("#F_ModuleId").comboBoxTree({
                    ...
                    click: function (i) {
                        ...
                        n("#F_ModuleBtnId").ComboBox({
                            url: "/AuthorizeManage/ModuleButton/GetListJson?moduleId=" + i.id,
                            id: "ModuleButtonId",
                            text: "FullName",
                            maxHeight: "300px",
                            allowSearch: !0,
                            ...
                            oncheckboxclick: function (t, i) {
                                if (i == 1) {
                                    var r = {
                                        ...
                                        F_FiledType: '<input name="F_FiledType" type="text" class="editable" value="' + t.datatype + '"  readonly />',
                                    ...
                                    function () {
                                        ...
                                        switch (o) {
                                            ...
                                            case "2":
                                                ...
                                                dialogOpen({
                                                    id: "SetFieldForm",
                                                    title: "设置字段关联属性【" + e + "】",  //ExcelImportTemplate
            ...
            initJqGird: function () {
                ...
                t.jqGrid({
                    ...
                    autowidth: !0,
                    colModel: [
                        { label: "字段名", name: "F_FliedName", hidden: !0 },
                        { label: "关联类型", name: "F_RelationType", hidden: !0 },
                        { label: "数据字典编码", name: "F_DataItemEncode", hidden: !0 },
                        { label: "固定数值", name: "F_Value", hidden: !0 },
                        { label: "库ID", name: "F_DbId", hidden: !0 },
                        { label: "表名", name: "F_DbTable", hidden: !0 },
                        { label: "保存数据字段", name: "F_DbSaveFlied", hidden: !0 },
                        { label: "对应字段", name: "F_DbRelationFlied", hidden: !0 },
                        { label: "字段", name: "F_FliedLabel", width: 200, align: "left", sortable: !1, resizable: !1 },
                        { label: "数据类型", name: "F_FiledType", width: 60, align: "left", sortable: !1, resizable: !1 },//F_FiledType
                        { label: "Excel列名", name: "F_ColName", width: 150, align: "left", sortable: !1, resizable: !1 },
                        { label: "唯一性", name: "F_OnlyOne", width: 60, align: "center", sortable: !1, resizable: !1 },
                        { label: "描述", name: "F_Description", width: 212, align: "left", sortable: !1, resizable: !1 },
                        { label: "操作", name: "F_SetBtn", width: 110, align: "center", sortable: !1, resizable: !1 }
                    ],
                    pager: !1,
                    rownumbers: !0,
                    shrinkToFit: !1,
        ...
        initialPage: function () {
            ...
            function () {
                ...
                t.saveForm({
                    ...
                    param: {
                        strEntity: JSON.stringify(u), //  //templateInfo
                        strChildEntitys: JSON.stringify(f)  ///filedsInfo
                    },
                    loading: "正在保存数据...",
                    success: function () {
