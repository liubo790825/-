...
function (n, t) {
    ...
    n.fn.authorizeButton = function () {
        ...
        function (n) {
            i.find("#" + r[n].EnCode).attr("authorize", "yes")
        });
    ...
    n.fn.uploadifyExSet = function (i, r) {
        ...
        t.setForm({
            ...
            success: function (t) {
                ...
                function (n, t) {
                    f.show();
                    var i = '<div id="' + t.Id + '"  class="uploadify-queue-item olduploadify-queue-item" ><a class="succeed" title="成功"><i class="fa fa-check-circle"><\/i><\/a><div style="float:left;width:50px;margin-right:2px;"><img src="/Content/images/filetype/' + t.FileType + '.png" style="width:40px;height:40px;"><\/div>'; (r == undefined || r.isRemove) && (i += '<div class="cancel remove" data-fileId="' + t.Id + '"><a title="删除" style="display: none;"><i class="fa fa-trash-o "><\/i><\/a><\/div>'); (r == undefined || r.isDown) && (i += '<div class="cancel down" data-fileId="' + t.Id + '"><a title="下载" style="display: none;margin-right:10px;"><i class="fa fa-download"><\/i><\/a><\/div>');
...
bddialogOpen = function (n) {
    learun.bddialogOpen(n)
};
