...
namespace LeaRun.Application.Service.SystemManage
{
    ...
    /// 描 述：数据导入详细设置
    /// </summary>
    public class System_SetExcelImportFiledService : RepositoryFactory<System_SetExcelImportFiledEntity>, ISystem_SetExcelImportFiledService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<System_SetExcelImportFiledEntity> GetPageList(string conn, Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<System_SetExcelImportFiledEntity> GetList(string conn, string queryJson)
        {
        ...
        /// <returns></returns>
        public System_SetExcelImportFiledEntity GetEntity(string conn, string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string conn, string keyValue, System_SetExcelImportFiledEntity entity)
        {
