...
namespace LeaRun.Application.Service.ArrangeLesson
{
    ...
    /// 描 述：InfoClass
    /// </summary>
    public class InfoClassService : RepositoryFactory<InfoClassEntity>, InfoClassIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<InfoClassEntity> GetList(string conn, string queryJson)
        {
        ...
        /// <returns></returns>
        public InfoClassEntity GetEntity(string conn, string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string conn, string keyValue, InfoClassEntity entity)
        {
