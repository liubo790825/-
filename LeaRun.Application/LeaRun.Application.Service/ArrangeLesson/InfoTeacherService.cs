...
namespace LeaRun.Application.Service.ArrangeLesson
{
    ...
    /// 描 述：InfoTeacher
    /// </summary>
    public class InfoTeacherService : RepositoryFactory<InfoTeacherEntity>, InfoTeacherIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<InfoTeacherEntity> GetList(string conn, string queryJson)
        {
        ...
        /// <returns></returns>
        public InfoTeacherEntity GetEntity(string conn, string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string conn, string keyValue, InfoTeacherEntity entity)
        {
