...
namespace LeaRun.Application.Service.ArrangeLesson
{
    ...
    /// 描 述：InfoPlace
    /// </summary>
    public class InfoPlaceService : RepositoryFactory<InfoPlaceEntity>, InfoPlaceIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        public IEnumerable<InfoPlaceEntity> GetList(string conn, string queryJson)
        {
        ...
        /// <returns></returns>
        public InfoPlaceEntity GetEntity(string conn, string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string conn, string keyValue, InfoPlaceEntity entity)
        {
