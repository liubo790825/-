    ...
    public class WFRuntimeService :RepositoryFactory, WFRuntimeIService
    {
        ...
        public bool CreateInstance(Guid processId, string schemeInfoId, WFProcessInstanceEntity wfProcessInstanceEntity, string frmData = null)
        {
            ...
            try
            {
                ...
                WRuntimeInitModel wfRuntimeInitModel = new WRuntimeInitModel()
                {
                ...
                IWRuntime wfruntime = null;
               
                wfruntime = new WRuntime(wfRuntimeInitModel);
        ...
        /// <param name="frmData">表单数据信息</param>
        /// <returns></returns>
        public bool CreateInstance_old(Guid processId, string schemeInfoId, WFProcessInstanceEntity wfProcessInstanceEntity, string frmData = null)
        {
            ...
            try
            {
                ...
                {
                    wfruntime = new WRuntime(wfRuntimeInitModel, GetFrmData);
                }
        ...
        /// <param name="frmData"></param>
        /// <returns></returns>
        public bool CreateInstance_old(WFProcessInstanceEntity wfProcessInstanceEntity, string frmData = null)
        {
            try
            {
                WFProcessInstanceEntity _wfProcessInstanceEntity = wfProcessInstanceService.GetEntity(wfProcessInstanceEntity.Id);
        ...
        /// <returns></returns>
        private string GetMakerList(IWRuntime wfruntime)
        {
            try
            {
                string makerList = "";
        ...
        private string GetMakerList(dynamic node, string processId)
        {
            try
            {
                ...
                {
                    if (node.setInfo.nodeDesignate.Value == "1")//所有成员
                    {
                        makerlsit = "1";
                    }
                    else if (node.setInfo.nodeDesignate.Value == "2")//指定成员
                    {
                    ...
                    else if (node.setInfo.nodeDesignate.Value == "3")//发起者领导
                    {
                    ...
                    else if (node.setInfo.nodeDesignate.Value == "4")//前一步骤领导
                    {
                    ...
                    else if (node.setInfo.nodeDesignate.Value == "5")//发起者部门领导
                    {
                        UserEntity userEntity = userService.GetEntity(OperatorProvider.Provider.Current().UserId);
                    ...
                    else if (node.setInfo.nodeDesignate.Value == "6")//发起者公司领导
                    {
                        UserEntity userEntity = userService.GetEntity(OperatorProvider.Provider.Current().UserId);
        ...
        /// <param name="node"></param>
        /// <returns></returns>
        private string GetMakerList_old(dynamic node, string processId)
        {
            try
            {
                string makerlsit = "";
