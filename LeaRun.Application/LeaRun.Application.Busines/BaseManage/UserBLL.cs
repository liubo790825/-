...
namespace LeaRun.Application.Busines.BaseManage
{
    ...
    public class UserBLL
    {
        ...
        //app
        public Dictionary<string, LeaRun.Application.Entity.WebApp.appUserInfoModel> GetListToApp()
        {
            Dictionary<string, LeaRun.Application.Entity.WebApp.appUserInfoModel> data = new Dictionary<string, LeaRun.Application.Entity.WebApp.appUserInfoModel>();
            var datalist = this.GetList();
            foreach (var item in datalist)
            {
                LeaRun.Application.Entity.WebApp.appUserInfoModel one = new LeaRun.Application.Entity.WebApp.appUserInfoModel
                {
                    UserId = item.UserId,
        ...
        {
            return service.GetAllUsersTable();
        }
        /// <summary>
        /// 用户实体
        /// </summary>
