...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    {
        private StudentsIService service = new StudentsService();
        ...
        public IEnumerable<StudentsEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<StudentsEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public StudentsEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, StudentsEntity entity)
        {
            try
            {
