...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：专业方向
    /// </summary>
    public class BK_MajorDetailBLL
    {
        private BK_MajorDetailIService service = new BK_MajorDetailService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_MajorDetailBLL()
        {
        ...
        public IEnumerable<BK_MajorDetailEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_MajorDetailEntity GetEntity(string keyValue)
        {
        ...
        /// <param name="keyValue">主键值</param>
        /// <returns></returns>
        public IEnumerable<BK_ClassInfoEntity> GetDetails(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_MajorDetailEntity entity,List<BK_ClassInfoEntity> entryList)
        {
            try
            {
