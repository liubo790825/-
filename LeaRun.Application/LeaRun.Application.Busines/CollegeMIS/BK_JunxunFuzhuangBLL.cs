...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// </summary>
    public class BK_JunxunFuzhuangBLL
    {
        private BK_JunxunFuzhuangIService service = new BK_JunxunFuzhuangService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_JunxunFuzhuangBLL()
        {
        ...
        public IEnumerable<BK_JunxunFuzhuangEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_JunxunFuzhuangEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_JunxunFuzhuangEntity GetEntity(string keyValue)
        {
            return service.GetEntity(conEntity.DbConnection,keyValue);
        }

        //获取军训服装信息
        public List<M_BK_JunxunFuzhuangEntity> GetJunXunFuList(Pagination pagination)
        {
            return service.GetJunXunFuList(conEntity.DbConnection, pagination);
        }
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_JunxunFuzhuangEntity entity)
        {
            try
            {
