...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// </summary>
    public class BK_AdvisoryAnswerBLL
    {
        private BK_AdvisoryAnswerIService service = new BK_AdvisoryAnswerService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_AdvisoryAnswerBLL()
        {
        ...
        public IEnumerable<BK_AdvisoryAnswerEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_AdvisoryAnswerEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_AdvisoryAnswerEntity GetEntity(string keyValue)
        {
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回分页列表</returns>
        public IEnumerable<BK_AdvisoryAnswerEntity> GetMyAnswer(Pagination pagination, string queryJson)
        {
            return service.GetMyAnswer(conEntity.DbConnection, pagination, queryJson);
        }
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_AdvisoryAnswerEntity entity)
        {
            try
            {
