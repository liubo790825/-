...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：综合素质内容表
    /// </summary>
    public class BK_OverallQualityBLL
    {
        private BK_OverallQualityIService service = new BK_OverallQualityService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_OverallQualityBLL()
        {
        ...
        public IEnumerable<BK_OverallQualityEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_OverallQualityEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_OverallQualityEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_OverallQualityEntity entity)
        {
            try
            {
