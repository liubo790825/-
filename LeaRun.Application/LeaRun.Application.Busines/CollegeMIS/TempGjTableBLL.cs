...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：TempGjTable
    /// </summary>
    public class TempGjTableBLL
    {
        private TempGjTableIService service = new TempGjTableService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public TempGjTableBLL()
        {
        ...
        public IEnumerable<TempGjTableEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<TempGjTableEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public TempGjTableEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, TempGjTableEntity entity)
        {
            try
            {
