...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：宿舍评级记录
    /// </summary>
    public class BK_RateDormLevelBLL
    {
        private BK_RateDormLevelIService service = new BK_RateDormLevelService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_RateDormLevelBLL()
        {
        ...
        public IEnumerable<BK_RateDormLevelEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_RateDormLevelEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_RateDormLevelEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_RateDormLevelEntity entity)
        {
            try
            {
