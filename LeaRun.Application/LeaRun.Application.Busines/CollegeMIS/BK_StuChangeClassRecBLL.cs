...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：学生换班记录
    /// </summary>
    public class BK_StuChangeClassRecBLL
    {
        private BK_StuChangeClassRecIService service = new BK_StuChangeClassRecService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_StuChangeClassRecBLL()
        {
        ...
        public IEnumerable<BK_StuChangeClassRecEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_StuChangeClassRecEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_StuChangeClassRecEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_StuChangeClassRecEntity entity)
        {
            try
            {
