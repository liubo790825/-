...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：学生社会关系表
    /// </summary>
    public class BK_StuSocRelaBLL
    {
        private BK_StuSocRelaIService service = new BK_StuSocRelaService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_StuSocRelaBLL()
        {
        ...
        public IEnumerable<BK_StuSocRelaEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_StuSocRelaEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_StuSocRelaEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_StuSocRelaEntity entity)
        {
            try
            {
