...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：社团活动表
    /// </summary>
    public class Community_ActivitiesBLL
    {
        private Community_ActivitiesIService service = new Community_ActivitiesService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public Community_ActivitiesBLL()
        {
        ...
        public IEnumerable<Community_ActivitiesEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<Community_ActivitiesEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public Community_ActivitiesEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Community_ActivitiesEntity entity)
        {
            try
            {
