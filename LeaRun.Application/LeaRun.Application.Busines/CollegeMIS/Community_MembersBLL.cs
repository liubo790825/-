...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：社团会员表
    /// </summary>
    public class Community_MembersBLL
    {
        private Community_MembersIService service = new Community_MembersService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public Community_MembersBLL()
        {
        ...
        public IEnumerable<Community_MembersEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<Community_MembersEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public Community_MembersEntity GetEntity(string keyValue)
        {
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public Community_MembersEntity GetSingleEntity( string queryJson)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Community_MembersEntity entity)
        {
            try
            {
