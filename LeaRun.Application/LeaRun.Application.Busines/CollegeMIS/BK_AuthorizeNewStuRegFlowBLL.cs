...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：报到流程授权表
    /// </summary>
    public class BK_AuthorizeNewStuRegFlowBLL
    {
        private BK_AuthorizeNewStuRegFlowIService service = new BK_AuthorizeNewStuRegFlowService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_AuthorizeNewStuRegFlowBLL()
        {
        ...
        public IEnumerable<BK_AuthorizeNewStuRegFlowEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_AuthorizeNewStuRegFlowEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_AuthorizeNewStuRegFlowEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_AuthorizeNewStuRegFlowEntity entity)
        {
            try
            {
