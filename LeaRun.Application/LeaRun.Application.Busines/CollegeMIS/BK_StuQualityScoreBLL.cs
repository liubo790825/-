...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：学生综合素质记录表
    /// </summary>
    public class BK_StuQualityScoreBLL
    {
        private BK_StuQualityScoreIService service = new BK_StuQualityScoreService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_StuQualityScoreBLL()
        {
        ...
        public IEnumerable<BK_StuQualityScoreEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回分页列表</returns>
        public DataTable GetPageListByDataSet(Pagination pagination, string queryJson)
        {
            return service.GetPageListByDataSet(conEntity.DbConnection, pagination, queryJson);
        }
        /// <summary>
        /// 获取列表
        /// </summary>
        ...
        public IEnumerable<BK_StuQualityScoreEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_StuQualityScoreEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_StuQualityScoreEntity entity)
        {
            try
            {
