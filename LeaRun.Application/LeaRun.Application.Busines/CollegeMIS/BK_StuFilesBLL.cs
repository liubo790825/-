...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：学生档案管理
    /// </summary>
    public class BK_StuFilesBLL
    {
        private BK_StuFilesIService service = new BK_StuFilesService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_StuFilesBLL()
        {
        ...
        public IEnumerable<BK_StuFilesEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_StuFilesEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_StuFilesEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_StuFilesEntity entity)
        {
            try
            {
