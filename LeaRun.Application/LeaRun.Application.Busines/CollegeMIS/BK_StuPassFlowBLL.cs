...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：记录新生报到
    /// </summary>
    public class BK_StuPassFlowBLL
    {
        private BK_StuPassFlowIService service = new BK_StuPassFlowService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_StuPassFlowBLL()
        {
        ...
        public IEnumerable<BK_StuPassFlowEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_StuPassFlowEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_StuPassFlowEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_StuPassFlowEntity entity)
        {
            try
            {
