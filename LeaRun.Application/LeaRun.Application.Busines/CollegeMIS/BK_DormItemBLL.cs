...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：BK_DormItem
    /// </summary>
    public class BK_DormItemBLL
    {
        private BK_DormItemIService service = new BK_DormItemService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_DormItemBLL()
        {
        ...
        public IEnumerable<BK_DormItemEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_DormItemEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_DormItemEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_DormItemEntity entity)
        {
            try
            {
