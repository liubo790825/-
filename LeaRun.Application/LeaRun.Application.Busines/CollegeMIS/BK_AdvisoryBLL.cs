...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：BK_Advisory
    /// </summary>
    public class BK_AdvisoryBLL
    {
        private BK_AdvisoryIService service = new BK_AdvisoryService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_AdvisoryBLL()
        {
        ...
        public IEnumerable<BK_AdvisoryEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_AdvisoryEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_AdvisoryEntity GetEntity(string keyValue)
        {
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回分页列表</returns>
        public IEnumerable<BK_AdvisoryEntity> TeaGetPageList(Pagination pagination, string queryJson)
        {
            return service.TeaGetPageList(conEntity.DbConnection, pagination, queryJson);
        }
        /// <summary>
        /// 教师端获取咨询学生列表
        /// </summary>
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回分页列表</returns>
        public IEnumerable<BK_AdvisoryEntity> TeaGetStuList(Pagination pagination)
        {
            return service.TeaGetStuList(conEntity.DbConnection, pagination);
        }
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_AdvisoryEntity entity)
        {
            try
            {
