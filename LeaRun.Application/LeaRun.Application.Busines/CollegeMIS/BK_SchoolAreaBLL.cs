...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：校区
    /// </summary>
    public class BK_SchoolAreaBLL
    {
        private BK_SchoolAreaIService service = new BK_SchoolAreaService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_SchoolAreaBLL()
        {
        ...
        public IEnumerable<BK_SchoolAreaEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回分页列表</returns>
        public IEnumerable<BK_SchoolAreaEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_SchoolAreaEntity GetEntity(string keyValue)
        {
        ...
        /// <param name="keyValue">主键值</param>
        /// <returns></returns>
        public IEnumerable<BK_DeptEntity> GetDetails(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_SchoolAreaEntity entity,List<BK_DeptEntity> entryList)
        {
            try
            {
