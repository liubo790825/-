...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：宿舍单元信息
    /// </summary>
    public class BK_DormUnitBLL
    {
        private BK_DormUnitIService service = new BK_DormUnitService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_DormUnitBLL()
        {
        ...
        public IEnumerable<BK_DormUnitEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_DormUnitEntity GetEntity(string keyValue)
        {
        ...
        /// <param name="keyValue">主键值</param>
        /// <returns></returns>
        public IEnumerable<BK_DormFloorsEntity> GetDetails(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_DormUnitEntity entity,List<BK_DormFloorsEntity> entryList)
        {
            try
            {
