...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// </summary>
    public class CommunityMembersBLL
    {
        private CommunityMembersIService service = new CommunityMembersService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public CommunityMembersBLL()
        {
        ...
        public IEnumerable<CommunityMembersEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<CommunityMembersEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public CommunityMembersEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, CommunityMembersEntity entity)
        {
            try
            {
