...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：学生入住床位记录
    /// </summary>
    public class BK_StuBedDwellBLL
    {
        private BK_StuBedDwellIService service = new BK_StuBedDwellService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public BK_StuBedDwellBLL()
        {
        ...
        public IEnumerable<BK_StuBedDwellEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<BK_StuBedDwellEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public BK_StuBedDwellEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public BK_StuBedDwellEntity GetEntityByWhere( string queryJson)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, BK_StuBedDwellEntity entity)
        {
            try
            {
