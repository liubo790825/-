...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：社团角色
    /// </summary>
    public class Community_RolesBLL
    {
        private Community_RolesIService service = new Community_RolesService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public Community_RolesBLL()
        {
        ...
        public IEnumerable<Community_RolesEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<Community_RolesEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public Community_RolesEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, Community_RolesEntity entity)
        {
            try
            {
