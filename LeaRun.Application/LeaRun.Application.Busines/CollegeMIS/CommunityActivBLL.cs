...
namespace LeaRun.Application.Busines.CollegeMIS
{
    ...
    /// 描 述：CommunityActiv
    /// </summary>
    public class CommunityActivBLL
    {
        private CommunityActivIService service = new CommunityActivService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public CommunityActivBLL()
        {
        ...
        public IEnumerable<CommunityActivEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<CommunityActivEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public CommunityActivEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, CommunityActivEntity entity)
        {
            try
            {
