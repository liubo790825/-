...
namespace LeaRun.Application.Busines.SystemManage
{
    ...
    public class DataItemBLL
    {
        ...
        public IEnumerable<LeaRun.Application.Entity.SystemManage.ViewModel.DataItemModel> GetDataItemList()
        {
            DataItemDetailBLL bll = new DataItemDetailBLL();
            var data = bll.GetDataItemList();
                return data;
        }
        /// <summary>
        /// 数据字典列表
        ...
        /// <returns></returns>
        public IEnumerable<LeaRun.Application.Entity.SystemManage.ViewModel.DataItemModel> GetDataItemList(string EnCode)
        {
            DataItemDetailBLL bll = new DataItemDetailBLL();
            var data = bll.GetDataItemList();//.Where(t => t.EnCode == EnCode);有问题
            return data;
        }
