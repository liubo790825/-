...
namespace LeaRun.Application.Busines.SystemManage
{
    ...
    {
        private ISystem_SetExcelImprotService service = new System_SetExcelImprotService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public System_SetExcelImprotBLL()
        {
        ...
        /// <param name="keyValue">主键值</param>
        /// <returns></returns>
        public IEnumerable<System_SetExcelImportFiledEntity> GetDetails(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, System_SetExcelImprotEntity entity)
        {
            try
            {
        ...
        /// <param name="entity">实体对象</param>
        /// <returns></returns>
        public void SaveForm(string keyValue, System_SetExcelImprotEntity entity,List<System_SetExcelImportFiledEntity> entryList)
        {
            try
            {
