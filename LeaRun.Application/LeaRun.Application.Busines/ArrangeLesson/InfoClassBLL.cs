...
namespace LeaRun.Application.Busines.ArrangeLesson
{
    ...
    {
        private InfoClassIService service = new InfoClassService();
        ...
        public IEnumerable<InfoClassEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public InfoClassEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, InfoClassEntity entity)
        {
            try
            {
