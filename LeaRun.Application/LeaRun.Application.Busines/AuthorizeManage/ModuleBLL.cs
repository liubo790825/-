...
namespace LeaRun.Application.Busines.AuthorizeManage
{
    ...
    public class ModuleBLL
    {
        ...
        public List<ModuleEntity> GetList(string parentId = "")
        {
            ...
            {
                data = data.FindAll(t => t.ParentId == parentId );//&& t.EnabledMark == 1
            }
            return data;
        }
        ...
        ///// </summary>
        ///// <param name="parentId">父级主键</param>
        ///// <param name="EnabledMark">是否启用</param>
        ///// <returns></returns>
        //public List<ModuleEntity> GetList(string parentId = "",int EnabledMark = 1)
        //{
        //    var data = service.GetList().ToList();
        //    if (!string.IsNullOrEmpty(parentId))
        //    {
