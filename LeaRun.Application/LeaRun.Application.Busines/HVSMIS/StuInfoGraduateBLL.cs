...
namespace LeaRun.Application.Busines.HVSMIS
{
    ...
    /// 描 述：毕业生基本信息
    /// </summary>
    public class StuInfoGraduateBLL
    {
        private StuInfoGraduateIService service = new StuInfoGraduateService();

        private Entity.SystemManage.DataBaseLinkEntity conEntity;
        #region 构造方法指定要连的数据库
        public StuInfoGraduateBLL()
        {
        ...
        public IEnumerable<StuInfoGraduateEntity> GetPageList(Pagination pagination, string queryJson)
        {
        ...
        public IEnumerable<StuInfoGraduateEntity> GetList(string queryJson)
        {
        ...
        /// <returns></returns>
        public StuInfoGraduateEntity GetEntity(string keyValue)
        {
        ...
        /// <returns></returns>
        public void SaveForm(string keyValue, StuInfoGraduateEntity entity)
        {
            try
            {
