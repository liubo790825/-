...
namespace LeaRun.Application.Busines.FlowManage
{
    ...
    public class WFRuntimeBLL
    {
        ...
        private WF_ProcessNodesIService nodesService = new WF_ProcessNodesService();
        private IForm_ModuleService formmoduleService = new Form_ModuleService();
        ...
        public List<WF_ProcessNodesEntity> ProcessNodesList(string queryJson)
        {
            return nodesService.GetList(queryJson);
        }
        ...
        public Form_ModuleEntity GetModuleEntity(string keyValue)
        {
            return formmoduleService.GetEntity(keyValue);
        }
