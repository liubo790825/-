...
namespace LeaRun.Application.AppSerivce
{
    ...
    /// 描 述：基类 //Nancy是一个用于构建基于HTTP 的Web服务的框架。
    //http://www.cnblogs.com/bnbqian/p/4933633.html
    /// </summary>
    public abstract class BaseModule : NancyModule
    {
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public Negotiator SendData(Object obj, string userid, string token, ResponseType type)
        {
            JsonSettings.MaxJsonLength = Int32.MaxValue;
